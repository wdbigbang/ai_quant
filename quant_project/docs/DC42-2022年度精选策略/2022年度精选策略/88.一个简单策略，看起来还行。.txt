...
def financial_statements_filter(context, security_list):
    ...
    security_list = financial_data_filter_qujian(security_list, valuation.pe_ratio_lyr, (0,120))
    ### _财务指标筛选函数-结束 ###
...
def sell(context, buy_lists):
    ...
    sell_lists = [security for security in sell_lists if CDL3BLACKCROWS_judge(security)]
    ### _出场函数筛选-结束 ###
